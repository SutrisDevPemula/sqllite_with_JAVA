...
public class AddMakanan extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (in.getStringExtra("nama") != null) {
            ...
            et_harga.setText(in.getStringExtra("Harga"));
            et_diskon.setText(in.getStringExtra("diskon"));
    ...
    private void create() {
        ...
        if (!TextUtils.isEmpty(et_nama.getText()) && !TextUtils.isEmpty(et_gambar.getText())) {
            ...
            if(TAG) {
                ...
                makanan.setHarga(et_harga.getText());
                makanan.setDiskon(et_diskon.getText());
